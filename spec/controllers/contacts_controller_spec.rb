...
describe ContactsController do
  ...
  shared_examples 'public access to contacts' do
    before :each do
      ...
      @contact = create(:contact, lastname: 'Gold')
    end
    ...
    describe 'GET #index' do
      ...
      context 'without params[:letter]' do
        it "populates an alphabetized array of all contacts" do
          get :index
          expect(assigns(:contacts)).to eq([@contact, @jones, @smith])
        end
  ...
  shared_examples 'full access to contacts' do
    ...
    describe 'PATCH #update' do
      ...
      context 'with valid attributes' do
        it "locates the contact in the database" do
          patch :update, id: @contact, contact: attributes_for(:contact)
          expect(assigns(:contact)).to eq(@contact)
        end

        it "changes attributes for the contact" do
          patch :update, id: @contact, contact: attributes_for(:contact,
            firstname: 'Larry',
            lastname: 'Smith')
          @contact.reload
